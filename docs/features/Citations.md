...
Citation parsing is a functionality of the [Citation](plugins/Citations.md) plugin. **This plugin is not enabled by default**. See the plugin page for customization options.
